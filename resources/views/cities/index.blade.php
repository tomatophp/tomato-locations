    ...
    <x-tomato-admin-row table :value="$item->shipping" />
                ...
                <x-splade-cell actions>
                    <div class="flex justify-start">
                        ...
                        <x-tomato-admin-button warning type="icon" title="{{trans('tomato-admin::global.crud.edit')}}" modal :href="route('admin.cities.edit', $item->id)">
                            <x-heroicon-s-pencil class="h-6 w-6"/>
                        </x-tomato-admin-button>
                        <x-tomato-admin-button danger type="icon" title="{{trans('tomato-admin::global.crud.delete')}}" :href="route('admin.cities.destroy', $item->id)"
